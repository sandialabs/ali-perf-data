...
# Warmup
srun ${SRUNCONF} ${APPDIR}/Albany input_albany_MueLu.yaml >& out-ant8k20L.hsw.warmup.txt
mv out-ant8k20L.hsw.warmup.txt hsw_timer_data/out-ant8k20L.hsw.warmup.txt

# Run cases
for (( sid=0; sid<${NUMSAMPLES}; sid++ ))
do
  srun ${SRUNCONF} ${APPDIR}/Albany input_albany_MueLu.yaml >& out-ant8k20L.hsw.${sid}.txt
  mv out-ant8k20L.hsw.${sid}.txt hsw_timer_data/out-ant8k20L.hsw.${sid}.txt
done
